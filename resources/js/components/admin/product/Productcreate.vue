<template>
	...
	<div class="col-12 mb-3 d-flex align-items-start flex-column">
		...
		<h1 class="p-0 m-0 text-body fw-bold">New Product</h1>
	</div>
	...
	<div class="row">
		...
		<div class="col-12 mb-3">
			<div class="d-flex flex-row gap-3 justify-content-end">
				...
				<button class="btn btn-outline-secondary" @click.prevent="discard">Discard</button>
			</div>
		</div>
